...
Tags: password, passwordless, magic link, authentication
Author: Swoop
...
The Swoop WordPress plugin is a simple and secure password-free authentication service.
...
Swoop: Password-Free Authentication is a 3rd party service that calls out to the following [password free authentication service]([https://auth.swoop.email/)](https://auth.swoop.email/). For more information on Swoops terms of service and privacy policy please visit our [legal page]([https://swoopnow.com/legal/](https://swoopnow.com/legal/)).
...
3.  Magic Message: Similar to the Magic Link but with even fewer steps and no typing. Swoop users will send the magic authentication email instead of receiving an email with a Magic Link.
